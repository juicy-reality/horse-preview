...
public class Demo01 {
	...
	private void init() throws IOException {
		glfwSetErrorCallback(errFun = GLFWErrorCallback.createPrint(System.err));
	...
	private void initComputeProgram() {
        ...
        ByteBuffer loadPngImage(String filePath)
        {
	...
	private int createFramebufferTexture() {
		...
		ByteBuffer black = null;//loadPngImage("vjuh.png");
